          ...
          <div className="flex flex-col">
            <div className="w-full aspect-w-1 aspect-h-1 bg-gray-200 rounded-lg overflow-hidden relative">
              ...
              <img
                src={logoFami}
                alt="Logo"
                className="absolute top-3 right-3 w-20 h-20 object-contain bg-white rounded-full shadow"                style={{ zIndex: 2 }}
              />
            </div>
            {/* Thư viện ảnh */}
            <div className="mt-4 flex gap-3 overflow-x-auto">
              {imageUrls?.map((imageUrl, index) => (
                <div
                  key={index}
                  className={`w-20 h-20 min-w-[64px] rounded-lg overflow-hidden border-2 cursor-pointer transition
