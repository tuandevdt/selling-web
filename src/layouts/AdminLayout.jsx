      ...
      >
        ...
        <div className="h-16 flex items-center justify-center border-b">
          ...
          <nav className="p-4">
            ...
            onClick={() => isMobile && setSidebarOpen(false)}
                >
            {/* Changed icon for Nhà cung cấp */}
            <svg className="w-6 h-6 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 7l9-4 9 4M4 10v10a1 1 0 001 1h3a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h3a1 1 0 001-1V10" />
            </svg>
            <span className="ml-3">Nhà cung cấp</span>
                </Link>
              </li>
              <li>
                <Link
