...
const FeaturedProjects = () => {
  const projects = [
    ...
    {
      id: 3,
      title: 'Govi cung cấp lắp đặt nội thất văn phòng cho MBBank',
      image: 'https://noithat52.mauthemewp.com/wp-content/uploads/2023/11/mbbank-600x313.jpg',
      url: '/projects/mbbank'
    },
    {
      id: 4,
      title: 'Govi cung cấp nội thất văn phòng cho tập đoàn Tân Hoàng Minh khắp cả nước',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-5xl mx-auto text-center mb-12">
          <p className="text-white text-lg leading-relaxed">
            Govi Furniture – Nơi hội tụ nét tinh hoa nội thất văn phòng, một hệ sinh thái đa dạng với nhiều sản phẩm độc đáo mang phong cách 
